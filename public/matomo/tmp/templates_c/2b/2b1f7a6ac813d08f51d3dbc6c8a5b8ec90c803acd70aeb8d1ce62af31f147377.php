...
class __TwigTemplate_ab5f22c5e85b962d04011835a28ce50e23dfafca23864aea2d3001e4246f7a6a extends Template
{
    private $source;
    private $macros = [];
...
";
                                ...
                                if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, $context["action"], "pageTitle", [], "any", false, false, false, 83))) {
                                    ...
                                    echo \Piwik\piwik_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["action"], "pageTitle", [], "any", false, false, false, 83), "html", null, true);
                                    echo "</span>";
                                }
                                // line 84
                                echo "
...
{% endif %}
", "@Live/getLastVisitsStart.twig", "/home/admin/web/descubriendoargentina.com/public_html/public/matomo/plugins/Live/templates/getLastVisitsStart.twig");
    }
}
