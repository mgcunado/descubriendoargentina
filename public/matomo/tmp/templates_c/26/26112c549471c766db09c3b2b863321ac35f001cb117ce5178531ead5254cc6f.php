...
class __TwigTemplate_d8702cc731297f6aef0fc2afe1450dff1861e6c96f68d120612a3e88f8510e7e extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <p>
            ";
            // line 26
            echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Installation_ProfessionalServicesfessionalDiscoverHow", (("<a rel=\"noreferrer noopener\" target=\"_blank\" href=\"" . (isset($context["linkToProfessionalServices"]) || array_key_exists("linkToProfessionalServices", $context) ? $context["linkToProfessionalServices"] : (function () { throw new RuntimeError('Variable "linkToProfessionalServices" does not exist.', 26, $this->source); })())) . "\">"), "</a>"]);
            echo "
        </p>
    ";
        }
    ...
    <p>";
        // line 31
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Installation_PerformanceSettingsDesc1", "<a href=\"https://matomo.org/docs/setup-auto-archiving/\" rel=\"noreferrer noopener\" target=\"_blank\">", "</a>"]);
        echo "</p>
    <p>";
        // line 32
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), ["Installation_PerformanceSettingsDesc2", "<a href=\"https://matomo.org/docs/setup-auto-archiving/\" rel=\"noreferrer noopener\" target=\"_blank\">", "</a>"]);
        echo "</p>
...
{% endblock %}
", "@Installation/finished.twig", "/home/admin/web/descubriendoargentina.com/public_html/public/matomo/plugins/Installation/templates/finished.twig");
    }
}
