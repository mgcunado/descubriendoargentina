...
";
            ...
            echo " ";
            if (((array_key_exists("isComparing", $context)) ? (_twig_default_filter((isset($context["isComparing"]) || array_key_exists("isComparing", $context) ? $context["isComparing"] : (function () { throw new RuntimeError('Variable "isComparing" does not exist.', 32, $this->source); })()), false)) : (false))) {
                echo "isComparing";
            }
            echo "\"
     data-table-type=\"";
...
{%- endif %}
", "@CoreHome/_dataTable.twig", "/home/admin/web/descubriendoargentina.com/public_html/public/matomo/plugins/CoreHome/templates/_dataTable.twig");
    }
}
