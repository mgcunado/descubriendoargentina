...
/* ajaxMacros.twig */
class __TwigTemplate_607d18ce112b72f5e9635f92939babe35961b0ee11136ff70f2a04e3cd287bc1 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_requestErrorDiv($__emailSuperUser__ = null, $__areAdsForProfessionalServicesEnabled__ = false, $__currentModule__ = "", ...$__varargs__)
    {
        ...
        <div class=\"alert alert-danger\">
            ...
            ";
            // line 20
            if ((array_key_exists("emailSuperUser", $context) && (isset($context["emailSuperUser"]) || array_key_exists("emailSuperUser", $context) ? $context["emailSuperUser"] : (function () { throw new RuntimeError('Variable "emailSuperUser" does not exist.', 20, $this->source); })()))) {
                // line 21
                echo "                ";
...
{% endmacro %}
", "ajaxMacros.twig", "/home/admin/web/descubriendoargentina.com/public_html/public/matomo/plugins/Morpheus/templates/ajaxMacros.twig");
    }
}
