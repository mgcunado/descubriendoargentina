...
class __TwigTemplate_f71612c819c618e82cc72bcfed66247ab70b664f37b8c7f9d5ce463619dd01b8 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if ((0 === twig_compare(twig_length_filter($this->env, (isset($context["sparklines"]) || array_key_exists("sparklines", $context) ? $context["sparklines"] : (function () { throw new RuntimeError('Variable "sparklines" does not exist.', 37, $this->source); })())), 1))) {
            ...
            foreach ($context['_seq'] as $context["key"] => $context["sparkline"]) {
                // line 39
                echo "                ";
                if ((twig_get_attribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, false, 39) % 2 == 1)) {
                    // line 40
                    echo "                    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                // line 45
                echo "                    ";
                if ((twig_get_attribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, false, 45) % 2 == 1)) {
                    // line 46
                    echo "                        <div>
                            ";
                    // line 47
...
{% endif %}", "@CoreVisualizations/_dataTableViz_sparklines.twig", "/home/admin/web/descubriendoargentina.com/public_html/public/matomo/plugins/CoreVisualizations/templates/_dataTableViz_sparklines.twig");
    }
}
