...
/* genericForm.twig */
class __TwigTemplate_87fa4f0298bd35a25a49d0d65112c5efa7ee34cc7d4b7db8568b86b977bd78ba extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["fieldname"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["form_data"] ?? null), $context["fieldname"], [], "array", true, true, false, 17)) {
                ...
                <div class=\"col s12 m12 l6\">
                    ";
                // line 20
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form_data"]) || array_key_exists("form_data", $context) ? $context["form_data"] : (function () { throw new RuntimeError('Variable "form_data" does not exist.', 20, $this->source); })()), $context["fieldname"], [], "array", false, false, false, 20), "type", [], "any", false, false, false, 20), "checkbox"))) {
                    // line 21
...
", "genericForm.twig", "/home/admin/web/descubriendoargentina.com/public_html/public/matomo/plugins/Morpheus/templates/genericForm.twig");
    }
}
