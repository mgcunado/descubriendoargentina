...
class __TwigTemplate_abc59985d0a6803718c0bb5e861c52e0ca42300e1983bd235f36ab472d64599c extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"segment-element borderedControl expanded\">
        ...
        echo "</option>
                            <option ";
        // line 47
        if ((isset($context["isSuperUser"]) || array_key_exists("isSuperUser", $context) ? $context["isSuperUser"] : (function () { throw new RuntimeError('Variable "isSuperUser" does not exist.', 47, $this->source); })())) {
            echo "selected=\"1\"";
        }
        echo " value=\"1\">";
        ...
        // line 53
        echo \Piwik\piwik_escape_filter($this->env, (isset($context["idSite"]) || array_key_exists("idSite", $context) ? $context["idSite"] : (function () { throw new RuntimeError('Variable "idSite" does not exist.', 53, $this->source); })()), "html", null, true);
        echo "\">";
        ...
        echo " <div class=\"auto_archive\"><strong>
                        <select class=\"auto_archive_select\">
                            ";
        // line 59
        if ((isset($context["createRealTimeSegmentsIsEnabled"]) || array_key_exists("createRealTimeSegmentsIsEnabled", $context) ? $context["createRealTimeSegmentsIsEnabled"] : (function () { throw new RuntimeError('Variable "createRealTimeSegmentsIsEnabled" does not exist.', 59, $this->source); })())) {
            // line 60
            echo "                            <option ";
            if ((isset($context["isBrowserArchivingEnabled"]) || array_key_exists("isBrowserArchivingEnabled", $context) ? $context["isBrowserArchivingEnabled"] : (function () { throw new RuntimeError('Variable "isBrowserArchivingEnabled" does not exist.', 60, $this->source); })())) {
                echo "selected=\"1\"";
            }
            echo " value=\"0\">";
        ...
        // line 62
        echo "                            <option ";
        if (( !(isset($context["isBrowserArchivingEnabled"]) || array_key_exists("isBrowserArchivingEnabled", $context) ? $context["isBrowserArchivingEnabled"] : (function () { throw new RuntimeError('Variable "isBrowserArchivingEnabled" does not exist.', 62, $this->source); })()) ||  !(isset($context["createRealTimeSegmentsIsEnabled"]) || array_key_exists("createRealTimeSegmentsIsEnabled", $context) ? $context["createRealTimeSegmentsIsEnabled"] : (function () { throw new RuntimeError('Variable "createRealTimeSegmentsIsEnabled" does not exist.', 62, $this->source); })()))) {
            echo "selected=\"1\"";
        }
        echo " value=\"1\">";
        ...
        echo "</a>
            ";
        // line 73
        if ((isset($context["isVisitorLogEnabled"]) || array_key_exists("isVisitorLogEnabled", $context) ? $context["isVisitorLogEnabled"] : (function () { throw new RuntimeError('Variable "isVisitorLogEnabled" does not exist.', 73, $this->source); })())) {
            // line 74
...
<div class=\"ui-confirm pleaseChangeBrowserAchivingDisabledSetting\">
    <h2>";
        // line 107
        echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [call_user_func_array($this->env->getFilter('translate')->getCallable(), ["SegmentEditor_SegmentNotApplied", (isset($context["nameOfCurrentSegment"]) || array_key_exists("nameOfCurrentSegment", $context) ? $context["nameOfCurrentSegment"] : (function () { throw new RuntimeError('Variable "nameOfCurrentSegment" does not exist.', 107, $this->source); })())])]);
        echo "</h2>
    ";
        // line 108
        ob_start();
        ...
        ";
        // line 110
        echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), [call_user_func_array($this->env->getFilter('translate')->getCallable(), ["SegmentEditor_SegmentNotAppliedMessage", (isset($context["nameOfCurrentSegment"]) || array_key_exists("nameOfCurrentSegment", $context) ? $context["nameOfCurrentSegment"] : (function () { throw new RuntimeError('Variable "nameOfCurrentSegment" does not exist.', 110, $this->source); })())])]);
        echo "
        <br/>
        ";
        // line 112
        ...
        ";
        // line 113
        if ((isset($context["isSuperUser"]) || array_key_exists("isSuperUser", $context) ? $context["isSuperUser"] : (function () { throw new RuntimeError('Variable "isSuperUser" does not exist.', 113, $this->source); })())) {
            // line 114
            echo "            <br/> <br/> ";
            echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), ["SegmentEditor_YouMayChangeSetting", "browser_archiving_disabled_enforce", (isset($context["segmentSetting"]) || array_key_exists("segmentSetting", $context) ? $context["segmentSetting"] : (function () { throw new RuntimeError('Variable "segmentSetting" does not exist.', 114, $this->source); })())]), "html", null, true);
            echo "
        ";
        }
        // line 116
...
";
    ...
    {
        return array (  317 => 118,  313 => 116,  307 => 114,  305 => 113,  301 => 112,  296 => 110,  293 => 109,  289 => 108,  285 => 107,  279 => 104,  275 => 103,  268 => 99,  258 => 92,  252 => 89,  244 => 86,  239 => 84,  235 => 83,  231 => 82,  221 => 76,  215 => 74,  213 => 73,  209 => 72,  205 => 71,  196 => 67,  183 => 62,  171 => 60,  169 => 59,  164 => 57,  160 => 55,  154 => 54,  148 => 53,  143 => 51,  132 => 47,  124 => 46,  119 => 44,  108 => 38,  100 => 32,  94 => 28,  87 => 26,  82 => 25,  80 => 24,  75 => 21,  69 => 19,  67 => 18,  56 => 10,  49 => 6,  40 => 2,  37 => 1,);
    }
...
", "@SegmentEditor/_segmentSelector.twig", "/home/admin/web/descubriendoargentina.com/public_html/public/matomo/plugins/SegmentEditor/templates/_segmentSelector.twig");
    }
}
